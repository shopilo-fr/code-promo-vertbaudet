#!/usr/bin/env python3
"""
Recuperation des codes promo Vertbaudet depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/vertbaudet.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/vertbaudet.fr"
STORE_NAME = "Vertbaudet"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Vertbaudet depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-vertbaudet)"
    }
    try:
